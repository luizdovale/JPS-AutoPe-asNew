    ...
    <Layout>
      ...
      <div className="bg-jps-main text-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-jps-gold/80 max-w-2xl mx-auto text-lg font-light tracking-wide animate-fade-in-up-delay-1 underline decoration-jps-gold/30 underline-offset-8">
